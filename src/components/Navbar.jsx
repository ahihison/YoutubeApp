  ...
  return (
    <Stack
      ...
      sx={{
        ...
        // add class name here to apply styles
        "&.Stack": {
    ...
    >
      <Box sx={{ display: { sm: "none", xs: "none", md: "flex" } }}>
        ...
        >
          ...
          >
            ...
            <g>
              <svg viewBox="0 0 90 20" fill="#fff">
                <path
      ...
      >
        <Tooltip
          title={<div style={{ padding: "8px", fontSize: "12px" }}>Tạo</div>}
        >
          <Box
            sx={{
              fontSize: "24px",
        ...
        <Tooltip
          title={
            <div style={{ padding: "8px", fontSize: "12px" }}>Thông báo</div>
          }
        >
          <Box
            sx={{
      ...
      >
        <MenuItem>
          <ListItemIcon>
            <RiVideoLine fontSize="24px" />
          </ListItemIcon>
          <ListItemText onClick={handleClose} className="menu-upvideo">
            Tải Video lên
          </ListItemText>
        </MenuItem>
        <MenuItem>
          <ListItemIcon>
            <CiStreamOn fontSize="24px" />
          </ListItemIcon>
          <ListItemText onClick={handleClose}>Phát trực tiếp</ListItemText>
        </MenuItem>
      </Menu>
    </Stack>
  );
